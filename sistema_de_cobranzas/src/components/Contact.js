                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} className="px-1">
                      <textarea rows="6" value={formDetails.message} placeholder="Detalle" onChange={(e) => onFormUpdate('message', e.target.value)}></textarea>
                      <button type="Entregar"><span>{buttonText}</span></button>
                    </Col>
                    {
                      status.message &&
                      <Col>
